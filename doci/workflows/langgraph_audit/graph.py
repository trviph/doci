...
A simple two-node chain — investigate, then conclude:

    START → find → verdict → END
...
from doci.workflows.langgraph_audit.nodes import make_find_node, make_verdict_node
...
def build_audit_graph(
    ...
    """Build + compile the audit graph (find → verdict) over the shared clients."""
