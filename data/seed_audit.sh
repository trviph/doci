...
know vendor-list "Vendor blacklist / whitelist" "Danh sách NCC bị cấm và NCC được duyệt" "## Vendor list\n\n- Blacklist: NCC/MST trong danh sách này thì BLOCK.\n- Whitelist: NCC đã thẩm định."
